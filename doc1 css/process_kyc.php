...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO kyc (aadhar,fullname, email, dob, address, income_proof,source_of_funds, photo)
            VALUES ('$aadhar','$fullname', '$email', '$dob', '$address', '$income_proof','$source_of_funds', '$photo')";
