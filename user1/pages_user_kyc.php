                                                ...
                                                <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                                  ...
                                                  <!--  <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                           <!-- <select class="form-control" name="gender">
                                                            ...
                                                            <input type="text" class="form-control" required name="gender" value="<?php echo $row->gender; ?>" id="inputName3">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" required  name="client_national_id" value="<?php echo $row->client_national_id; ?>" id="inputName2">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" required  name="pan_no" value="<?php echo $row->pan_no; ?>" id="inputName2">
